...
static const struct tegra30_emc_table TF700T_Elpida_1GB[] = {
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra30_emc_table elpida_1GB_EDB8132B2MA_8D_lpddr2_400MHz[] ={
	{
		0x31,       /* Rev 3.1 */
		25500,      /* SDRAM frequency */
		{
			...
			0x00020001, /* MC_EMEM_ARB_CFG */
			0x80000010, /* MC_EMEM_ARB_OUTSTANDING_REQ */
			0x00000001, /* MC_EMEM_ARB_TIMING_RCD */
			0x00000001, /* MC_EMEM_ARB_TIMING_RP */
			0x00000002, /* MC_EMEM_ARB_TIMING_RC */
			0x00000000, /* MC_EMEM_ARB_TIMING_RAS */
	...
	},
	{
		...
		102000,     /* SDRAM frequency */
		{
			...
			0x8000040b, /* EMC_DYN_SELF_REF_CONTROL */
			0x00000001, /* MC_EMEM_ARB_CFG */
			0x80000018, /* MC_EMEM_ARB_OUTSTANDING_REQ */
			0x00000001, /* MC_EMEM_ARB_TIMING_RCD */
			0x00000001, /* MC_EMEM_ARB_TIMING_RP */
			0x00000003, /* MC_EMEM_ARB_TIMING_RC */
	...
	},
	{
		...
		400000,     /* SDRAM frequency */
		{
			...
			0x001d0084, /* EMC_CFG_DIG_DLL */
			0x00008000, /* EMC_CFG_DIG_DLL_PERIOD */
			0x0002c000, /* EMC_DLL_XFORM_DQS0 */
			0x0002c000, /* EMC_DLL_XFORM_DQS1 */
			0x0002c000, /* EMC_DLL_XFORM_DQS2 */
			0x0002c000, /* EMC_DLL_XFORM_DQS3 */
			0x00000010, /* EMC_DLL_XFORM_DQS4 */
			0x00000010, /* EMC_DLL_XFORM_DQS5 */
			0x00000010, /* EMC_DLL_XFORM_DQS6 */
			0x00000010, /* EMC_DLL_XFORM_DQS7 */
...
static const struct tegra30_emc_table dvfs_TF201_500MHZ[] ={
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
	...
	},
	{
		...
		204000,     /* SDRAM frequency */
		{
			...
			0x00000000, /* EMC_DLI_TRIM_TXDQS6 */
			0x00000000, /* EMC_DLI_TRIM_TXDQS7 */
			0x000d0000, /* EMC_DLL_XFORM_DQ0 */
			0x000d0000, /* EMC_DLL_XFORM_DQ1 */
			0x000d0000, /* EMC_DLL_XFORM_DQ2 */
			0x000d0000, /* EMC_DLL_XFORM_DQ3 */
	...
	},
	{
		...
		500000,     /* SDRAM frequency */
		{
			...
			0x0000000d, /* EMC_QSAFE */
			0x0000000f, /* EMC_RDV */
			0x00000763, /* EMC_REFRESH */
			0x00000000, /* EMC_BURST_REFRESH_NUM */
			0x000001d8, /* EMC_PRE_REFRESH_REQ_CNT */
			0x00000003, /* EMC_PDEX2WR */
			...
			0x00000046, /* EMC_TXSR */
			0x00000046, /* EMC_TXSRDLL */
			0x00000008, /* EMC_TCKE */
			0x00000019, /* EMC_TFAW */
			0x0000000b, /* EMC_TRPAB */
			0x00000004, /* EMC_TCLKSTABLE */
			0x00000002, /* EMC_TCLKSTOP */
			0x00000820, /* EMC_TREFBW */
			0x00000000, /* EMC_QUSE_EXTRA */
			0x00000006, /* EMC_FBIO_CFG6 */
			0x00000000, /* EMC_ODT_WRITE */
			0x00000000, /* EMC_ODT_READ */
			...
			0x00000802, /* EMC_CTT_TERM_CTRL */
			0x00064000, /* EMC_ZCAL_INTERVAL */
			0x000000b4, /* EMC_ZCAL_WAIT_CNT */
			0x000d000d, /* EMC_MRS_WAIT_CNT */
			0xa0f10404, /* EMC_AUTO_CAL_CONFIG */
			0x00000000, /* EMC_CTT */
			0x00000000, /* EMC_CTT_DURATION */
			0x80000fde, /* EMC_DYN_SELF_REF_CONTROL */
			0x00000007, /* MC_EMEM_ARB_CFG */
			0x8000005a, /* MC_EMEM_ARB_OUTSTANDING_REQ */
			...
			0x00100a0e, /* MC_EMEM_ARB_DA_COVERS */
			0x71c8170f, /* MC_EMEM_ARB_MISC0 */
			0x001f0000, /* MC_EMEM_ARB_RING1_THROTTLE */
			0xe0000000, /* EMC_FBIO_SPARE */
			0xff00ff88, /* EMC_CFG_RSV */
		},
		0x0000002d, /* EMC_ZCAL_WAIT_CNT after clock change */
		0x001fffff, /* EMC_AUTO_CAL_INTERVAL */
		0x00000001, /* EMC_CFG.PERIODIC_QRST */
		0x00000000, /* Mode Register 0 */
...
static const struct tegra30_emc_table TF300T_Elpida_1GB_667MHZ[] ={
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra30_emc_table TF300T_Hynix_1GB_667MHZ[] ={
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
	...
	},
	{
		...
		204000,     /* SDRAM frequency */
		{
			...
			0x00000006, /* MC_EMEM_ARB_TIMING_W2R */
			0x06020102, /* MC_EMEM_ARB_DA_TURNS */
			0x000a0605, /* MC_EMEM_ARB_DA_COVERS */
			0x72440a06, /* MC_EMEM_ARB_MISC0 */
			0x001f0000, /* MC_EMEM_ARB_RING1_THROTTLE */
			0xe8000000, /* EMC_FBIO_SPARE */
			0xff00ff00, /* EMC_CFG_RSV */
...
static const struct tegra30_emc_table TF300T_Micron_1GB_667MHZ[] ={
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
	...
	},
	{
		...
		667000,     /* SDRAM frequency */
		{
			...
			0x00000008, /* MC_EMEM_ARB_TIMING_W2R */
			0x08040202, /* MC_EMEM_ARB_DA_TURNS */
			0x00140b10, /* MC_EMEM_ARB_DA_COVERS */
			0x70ea1f11, /* MC_EMEM_ARB_MISC0 */
			0x001f0000, /* MC_EMEM_ARB_RING1_THROTTLE */
		...
		0x80000b71, /* Mode Register 0 */
		0x80100002, /* Mode Register 1 */
		0x80200058, /* Mode Register 2 */
		0x00000000, /* EMC_CFG.DYN_SELF_REF */
	},
};

static const struct tegra30_emc_table TF300TG_Elpida_1GB_667MHZ[] ={
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra30_emc_table TF300TG_Hynix_1GB_667MHZ[] ={
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra30_emc_table TF300TG_Micron_1GB_667MHZ[] ={
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra30_emc_table TF300TL_Elpida_1GB_667MHZ[] ={
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra30_emc_table TF300TL_Hynix_1GB_667MHZ[] ={
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static struct tegra30_emc_pdata cardhu_emc_chip_TF700T_Micron_1GB = {
	.description = "TF700T_Micron_1GB",
	.tables = (struct tegra30_emc_table *)TF700T_Micron_1GB,
	.num_tables = ARRAY_SIZE(TF700T_Micron_1GB)
};

static struct tegra30_emc_pdata cardhu_emc_chip_TF700T_Elpida_1GB = {
	.description = "TF700T_Elpida_1GB",
	.tables = (struct tegra30_emc_table *)TF700T_Elpida_1GB,
	.num_tables = ARRAY_SIZE(TF700T_Elpida_1GB)
};

static struct tegra30_emc_pdata cardhu_emc_chip_elpida_1GB_EDB8132B2MA_8D_lpddr2_400MHz = {
	.description = "elpida_1GB_EDB8132B2MA_8D_lpddr2_400MHz",
	.tables = (struct tegra30_emc_table *)elpida_1GB_EDB8132B2MA_8D_lpddr2_400MHz,
	.num_tables = ARRAY_SIZE(elpida_1GB_EDB8132B2MA_8D_lpddr2_400MHz)
};

static struct tegra30_emc_pdata cardhu_emc_chip_dvfs_TF201_500MHZ = {
	.description = "TF201_500MHZ",
	.tables = (struct tegra30_emc_table *)dvfs_TF201_500MHZ,
	.num_tables = ARRAY_SIZE(dvfs_TF201_500MHZ)
};

static struct tegra30_emc_pdata cardhu_emc_chip_TF300T_Elpida_1GB_667MHZ = {
	.description = "TF300T_Elpida_1GB_667MHZ",
	.tables = (struct tegra30_emc_table *)TF300T_Elpida_1GB_667MHZ,
	.num_tables = ARRAY_SIZE(TF300T_Elpida_1GB_667MHZ)
};

static struct tegra30_emc_pdata cardhu_emc_chip_TF300T_Hynix_1GB_667MHZ = {
	.description = "TF300T_Hynix_1GB_667MHZ",
	.tables = (struct tegra30_emc_table *)TF300T_Hynix_1GB_667MHZ,
	.num_tables = ARRAY_SIZE(TF300T_Hynix_1GB_667MHZ)
};

static struct tegra30_emc_pdata cardhu_emc_chip_TF300T_Micron_1GB_667MHZ = {
	.description = "TF300T_Micron_1GB_667MHZ",
	.tables = (struct tegra30_emc_table *)TF300T_Micron_1GB_667MHZ,
	.num_tables = ARRAY_SIZE(TF300T_Micron_1GB_667MHZ)
};

static struct tegra30_emc_pdata cardhu_emc_chip_TF300TG_Elpida_1GB_667MHZ = {
	.description = "TF300TG_Elpida_1GB_667MHZ",
	.tables = (struct tegra30_emc_table *)TF300TG_Elpida_1GB_667MHZ,
	.num_tables = ARRAY_SIZE(TF300TG_Elpida_1GB_667MHZ)
};

static struct tegra30_emc_pdata cardhu_emc_chip_TF300TG_Hynix_1GB_667MHZ = {
	.description = "TF300TG_Hynix_1GB_667MHZ",
	.tables = (struct tegra30_emc_table *)TF300TG_Hynix_1GB_667MHZ,
	.num_tables = ARRAY_SIZE(TF300TG_Hynix_1GB_667MHZ)
};

static struct tegra30_emc_pdata cardhu_emc_chip_TF300TG_Micron_1GB_667MHZ = {
	.description = "TF300TG_Micron_1GB_667MHZ",
	.tables = (struct tegra30_emc_table *)TF300TG_Micron_1GB_667MHZ,
	.num_tables = ARRAY_SIZE(TF300TG_Micron_1GB_667MHZ)
};

static struct tegra30_emc_pdata cardhu_emc_chip_TF300TL_Elpida_1GB_667MHZ = {
	.description = "TF300TL_Elpida_1GB_667MHZ",
	.tables = (struct tegra30_emc_table *)TF300TL_Elpida_1GB_667MHZ,
	.num_tables = ARRAY_SIZE(TF300TL_Elpida_1GB_667MHZ)
};

static struct tegra30_emc_pdata cardhu_emc_chip_TF300TL_Hynix_1GB_667MHZ = {
	.description = "TF300TL_Hynix_1GB_667MHZ",
	.tables = (struct tegra30_emc_table *)TF300TL_Hynix_1GB_667MHZ,
	.num_tables = ARRAY_SIZE(TF300TL_Hynix_1GB_667MHZ)
};
